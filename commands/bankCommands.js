module.exports = async (bot, config) => {
    ...
    bot.on('message', async msg => {
        ...
        if (msg.content.toLowerCase.startsWith("-dontateto") && settings.economyCommandsEnabled == true) {
            var args = [];
            ...
            if (id == '') {
                ...
                fs.readFile('shop.json', 'utf8', function (err, data) {
                    ...
                    if (recIndex != -1) {
                        if (data[index].money >= amount) {
                            if (userIndex != -1) {
                                data[recIndex].money += amount;
        ...
        else if (msg.content.toLowerCase.startsWith("-dontateto")) {
