...
bot.on('messageReactionAdd', async (reaction, user) => {
    ...
    if(!!reaction.message.cache.find(v => v.name == ':one:') && reaction.message.id === '738116196729225226'){
    ...
    if(!!reaction.message.cache.find(v => v.name == ':two:') && reaction.message.id === '738116196729225226'){
    ...
    if(!!reaction.message.cache.find(v => v.name == ':three:') && reaction.message.id === '738116196729225226'){
