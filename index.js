...
bot.on('messageReactionAdd', async (reaction, user) => {
    ...
    if(reaction === '1️⃣' && reaction.message.id === '738116196729225226'){
    ...
    if(reaction === '2️⃣' && reaction.message.id === '738116196729225226'){
    ...
    if(reaction === '3️⃣' && reaction.message.id === '738116196729225226'){
