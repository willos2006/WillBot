...
bot.on('messageReactionAdd', async (reaction, user) => {
    ...
    if(reaction.message.id === '738112386279669792'){
        console.log("hi");
        user.addRole(reaction.message.guild.members.roles.find(role => role.name === "Verified"));
    ...
    if(reaction === ':one:' && reaction.message.id === '738116196729225226'){
        console.log("one");
        user.addRole(reaction.message.guild.members.roles.find(role => role.name === "13-14"));
        user.send("You have the `13-14` role!");
    }
    if(reaction === ':two:' && reaction.message.id === '738116196729225226'){
        console.log("two");
        user.addRole(reaction.message.guild.members.roles.find(role => role.name === "15-16"));
        user.send("You have the `15-16` role!");
    }
    if(reaction === ':three:' && reaction.message.id === '738116196729225226'){
        console.log("three");
        user.addRole(reaction.message.guild.members.roles.find(role => role.name === "17-18"));
