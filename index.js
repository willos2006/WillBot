...
bot.on('ready', () => {
	...
	let msg1 = rolesChan.messages.cache.find(message => message.id === "738116196729225226");
	let msg2 = rolesChan.messages.cache.find(message => message.id === "738444446768824372");
	msg1.react("1️⃣");
	msg1.react("2️⃣");
	msg1.react("3️⃣");
	msg2.react("🔴");
